...
const PhoneIcon = () => (
  ...
  >
    <path
      d="M22 16.92v3a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.86 19.86 0 0 1 3.09 4.18 2 2 0 0 1 5 2h3a2 2 0 0 1 2 1.72c.12.91.38 1.8.76 2.63a2 2 0 0 1-.45 2.11L9.91 9.91a16 16 0 0 0 6 6l1.35-1.35a2 2 0 0 1 2.11-.45c.83.38 1.72.64 2.63.76A2 2 0 0 1 22 16.92z"
      fill="currentColor"
    />
  </svg>
);
...
const WebsiteIcon = () => (
  ...
  >
    <path
      d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm6.9 11H18a13 13 0 0 1 0-2h.9A8.96 8.96 0 0 1 18.9 13zM12 4c1.48 1.75 2.5 4.1 2.83 7H9.17C9.5 8.1 10.52 5.75 12 4zM6.1 13H8a13 13 0 0 1 0-2H6.1a8.96 8.96 0 0 1 0 2zM12 20c-1.48-1.75-2.5-4.1-2.83-7h5.66C14.5 15.9 13.48 18.25 12 20z"
      fill="currentColor"
    />
  </svg>
);
...
const WhatsAppIcon = () => (
  ...
  >
    <path
      d="M20.52 3.48A11.88 11.88 0 0 0 12 0C5.37 0 .02 5.35.02 12.01c0 2.12.55 4.17 1.6 5.97L0 24l6.24-1.62A11.93 11.93 0 0 0 12 24c6.63 0 12-5.35 12-11.99 0-3.2-1.25-6.2-3.48-8.53zM12 21.5c-1.16 0-2.3-.3-3.3-.86l-.24-.14-3.71.97.99-3.62-.15-.25A8.5 8.5 0 1 1 20.5 12 8.45 8.45 0 0 1 12 21.5zM17.05 14.17c-.27-.14-1.6-.79-1.85-.88-.25-.09-.43-.14-.61.14s-.7.88-.86 1.06c-.16.18-.32.2-.6.07-.27-.13-1.13-.42-2.15-1.33-.8-.72-1.34-1.6-1.5-1.87-.16-.27-.02-.42.12-.56.12-.12.27-.32.41-.48.14-.16.19-.27.28-.45.09-.18.04-.34-.02-.48-.06-.14-.61-1.47-.84-2.02-.22-.53-.45-.46-.62-.47l-.53-.01c-.18 0-.48.07-.73.34-.25.27-1 1-1 2.5s1.03 2.9 1.17 3.1c.14.18 2.02 3.08 4.9 4.32 2.72 1.18 2.72.79 3.21.74.5-.06 1.6-.65 1.83-1.28.23-.63.23-1.17.16-1.28-.07-.11-.25-.17-.52-.31z"
      fill="currentColor"
    />
  </svg>
);
  ...
  return (
    ...
    >
      ...
      <div className="card-content">
        ...
        {((coordinator.phone && coordinator.phone.length) ||
          (coordinator.email && coordinator.email.length) ||
          (coordinator.studentCoordinators &&
            coordinator.studentCoordinators.length)) && (
          <div className="contact-details">
            ...
            {coordinator.studentCoordinators && (
              <div className="student-coordinators">
                <ul>
                  {coordinator.studentCoordinators?.map(
                    (sc: Student, i: number) => (
                      <li key={i}>
                        {sc.name}{" "}
                        {sc.phone && (
...
const GeneralContactCard: React.FC<{ contact: GeneralContact }> = ({
  contact,
}) => {
  const [ref, inView] = useInView<HTMLDivElement>({ threshold: 0.12 });
  return (
    <div
      ref={ref as React.RefObject<HTMLDivElement>}
      className={`general-contact-card ${inView ? "reveal" : "hidden"}`}
    >
...
const StudentCard: React.FC<{ s: Student }> = ({ s }) => {
  ...
  return (
    <div
      ref={ref as React.RefObject<HTMLDivElement>}
      className={`student-card ${inView ? "reveal" : "hidden"}`}
    >
...
const Contact = () => {
  const coordinators = [
    ...
    },
    {
      ...
      phone: "+91 6360 715 535",
      studentCoordinators: [],
    },
    {
      activity: "Ideathon",
      name: "Prof. Varalakshmi K V",
  ...
  const studentList = [
    ...
    },
    {
      ...
      branch: "ISE",
      semester: "5",
      email: "sanjana.23ise@cambridge.edu.in",
    },
    {
    ...
    {
      name: "Prema B Malipatil",
      usn: "1CD23IS114",
      branch: "ISE",
      semester: "5",
      email: "prema.23ise@cambridge.edu.in",
    },
    {
      name: "Yukthi M",
      usn: "1CD23CS200",
      branch: "CSE",
      semester: "5",
      email: "yukthim.23cse@cambridge.edu.in",
    },
    {
    ...
    },
    {
      ...
      branch: "CSE",
      semester: "5",
      email: "jeevanl.23cse@cambridge.edu.in",
    },
    {
      ...
      branch: "CSE",
      semester: "5",
      email: "vivek.23cse@cambridge.edu.in",
    },
    {
      name: "Jaijan S",
      usn: "1CD23AI045",
    ...
    },
    {
      ...
      branch: "AIML",
      semester: "5",
      email: "sushmitha.23eee@cambridge.edu.in",
    },
    {
      name: "Yamini",
      usn: "1CD23AI125",
      branch: "AIML",
      semester: "5",
      email: "yamini.23aiml@cambridge.edu.in",
    },
    {
      name: "Mayyoga",
      usn: "1CD23IS091",
      branch: "ISE",
      semester: "5",
      email: "mayooga.23ise@cambridge.edu.in",
    },
    {
      name: "M Tarani Lakshmi",
      usn: "1CD23IS082",
      branch: "ISE",
      semester: "5",
      email: "taranilakshmi.23ise@cambridge.edu.in",
    },
  ];
    ...
    <div className="contact">
      ...
      <section className="student-coordinators">
        <div className="container">
          ...
          <p className="section-description">
            Contact details for student coordinators
          </p>
